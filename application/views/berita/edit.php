      ...
      <div class="box box-primary">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="box-header with-border">
            ...
            <input type="text" class="form-control" name="judul" placeholder="Judul Berita" style="border-radius: 5px;" autocomplete="off" value="<?= $berita['judul']; ?>">
            <small id="pesanError" class="form-text text-danger"><?= form_error('judul'); ?></small>
          </div>
          <div class="box-header with-border">
            <label>Tempat Pelaksanaan</label>
            <input type="text" class="form-control" name="tempat" placeholder="Tempat" style="border-radius: 5px;" autocomplete="off" value="<?= $berita['tempat']; ?>">
          ...
          <div class="form-group box-header with-border">
            ...
            <div class="input-group date">
              ...
              <input type="text" class="form-control pull-right" name="tanggal" id="datepicker"  style="border-radius: 0 5px 5px 0;" autocomplete="off" value="<?= $berita['tanggal']; ?>">
            </div>
          ...
          <!-- /.date -->
      		<div class="form-group box-header with-border">
            <label>Gambar</label>
      			<input class="form-control" type="file" id="InputFile" name="file" style="border-radius: 5px;" autocomplete="off" required value="<?= $berita['cover']; ?>">
      		</div>
          <!-- /.box-body -->
          <div class="form-group box-header with-border">
            <label>Konten</label>
            <textarea class="form-control texteditor" name="isiBerita" id="isiBerita" cols="30" rows="10" autocomplete="off"><?= $berita['content']; ?></textarea>
            <small id="pesanError" class="form-text text-danger"><?= form_error('isiBerita'); ?></small>
          </div>
          <!-- /.textarea-->
          <button type="submit" name="edit" class="btn btn-primary" style="min-width: 120px; margin: 10px;">Edit <i class="fa fa-send"></i></button>
        </form>
      </div>
      <!-- /.box -->
